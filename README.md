...
A quantitative trading platform based on Hummingbot, focusing on cryptocurrency arbitrage strategies.

## Features

- Spot-perpetual arbitrage strategies
- Market-neutral trading approach
- Advanced risk management
- Optimized for various market conditions

## Documentation

Documentation for specific strategies can be found in the `scripts` directory.
