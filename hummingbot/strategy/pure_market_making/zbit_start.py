...
from hummingbot.strategy.pure_market_making.zbit_pure_market_making_config_map import zbit_pure_market_making_config_map as c_map
...
def start(self):
    ...
    try:
        self.logger().info("Starting Zbit Pure Market Making Strategy...")
        ...
        self.logger().info("Zbit Pure Market Making Strategy initialized successfully.")
